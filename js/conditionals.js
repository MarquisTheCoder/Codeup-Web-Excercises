...
alert(calculateTotal(prompt('whats your lucky number?: '),
                     prompt('whats your total bill?: ' )));
/**
 * TODO:
...
const isEven = number => (number % 2 === 0) ? 'Your number is Even\n' : 'Your number Odd\n';
const plusOneHundred = number => `Your number(${number}) + 100 = ${number + 100}\n`;
